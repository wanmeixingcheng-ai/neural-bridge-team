export const WORKFLOW_STATUS_LABELS = {
  zh: { idle:"待命中", planning:"规划中", waiting_confirmation:"等待确认", running:"执行中", summarizing:"汇总中", done:"已完成", failed:"失败", stopped:"已停止", queued:"待执行", working:"执行中", complete:"已完成" },
  ja: { idle:"待機中", planning:"計画中", waiting_confirmation:"確認待ち", running:"実行中", summarizing:"統合中", done:"完了", failed:"失敗", stopped:"停止", queued:"待機", working:"実行中", complete:"完了" },
  en: { idle:"Ready", planning:"Planning", waiting_confirmation:"Waiting for confirmation", running:"Running", summarizing:"Summarizing", done:"Done", failed:"Failed", stopped:"Stopped", queued:"Queued", working:"Working", complete:"Done" },
};
