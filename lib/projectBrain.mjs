...
function knowledgeBrainInventoryStats({ sources = [], knowledgeUnits = [], evidenceRefs = [], policyRules = [], scenarios = [], evalCases = [], japaneseRealEstateRecords = [], calculationRuns = [], propertyDossiers = [], toolValidationRuns = [] } = {}) {
...
async function knowledgeStats() {
  ...
  const [docs, memories, archived, sources, knowledgeUnits, evidenceRefs, policyRules, scenarios, evalCases, calculationRuns, propertyDossiers, toolValidationRuns, ...jreRecordGroups] = await Promise.all([
  ...
  return {
    ...knowledgeBrainInventoryStats({ sources, knowledgeUnits, evidenceRefs, policyRules, scenarios, evalCases, japaneseRealEstateRecords, calculationRuns, propertyDossiers, toolValidationRuns }),
